...
(function($) {
    ...
    Selectik.prototype = {
        ...
        _getList: function(e){
            ...
            if (e.refreshSelect){
                html = '<div class="select-list '+scrollClass+'">'+scrollHtml+'<div class="select-ul-wrap"><ul>'+html+'</ul></div></div>';
                $(html).prependTo(this.$container);
            }else{
                html = '<span class="custom-text">'+this.$selected[0].text+'</span><div class="select-list '+scrollClass+'">'+scrollHtml+'<div class="select-ul-wrap"><ul>'+html+'</ul></div></div>';
                $(html).prependTo(this.$container);
            }
